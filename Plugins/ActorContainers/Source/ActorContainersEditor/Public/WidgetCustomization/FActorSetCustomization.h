...
class FActorSetCustomization final : public FActorContainerCustomization
{
public:
	/**
...
protected:
	...
	virtual void RemoveItemFromContainer(const uint32 ItemIndex = 0) override;
...
protected:
	...
	TSharedPtr<IPropertyHandleSet> SetHandle;
